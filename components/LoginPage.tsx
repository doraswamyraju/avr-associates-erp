...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
    ...
    const handleForgotPassword = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSuccessMessage(data.message || 'If this email is registered, a reset link has been sent.');
        } catch (err: any) {
                        ...
                        {view === 'login' ? (
                            ...
                            <>
                                <div className="mb-10">
                                    ...
                                    <p className="text-slate-400 text-sm font-medium">Enter your email and we'll send you a secure link to reset your password.</p>
                                </div>
                                ...
                                {successMessage && (
                                    <div className="mb-8 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 p-4 rounded-2xl text-xs font-bold flex items-start gap-3 animate-in fade-in slide-in-from-top-2">
                                ...
                                <form onSubmit={handleForgotPassword} className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            <div className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-indigo-400 transition-colors">
                                                <KeyRound size={18} className="rotate-90" />
                                            </div>
                                            <input
                                                type="email"
                                                value={email}
